...
export { default as toType } from './function/toType';
export { default as getSystem } from './function/getSystem';
...
export { default as paramsUrl } from './url/paramsUrl';
export { default as urlParams } from './url/urlParams';
